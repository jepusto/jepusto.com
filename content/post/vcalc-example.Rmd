...
Here's a little made-up dataset with data from two samples, where sample 1 has three treatment arms and sample 2 has two treatment arms:
```{r}
A_dat <- data.frame(
