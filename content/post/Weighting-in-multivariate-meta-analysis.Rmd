...
$$
for some weights $w_1,...,w_k$. The question is then, what are these weights? Just like in the basic random effects model, they are inverse-variance weights. It's just that the variance is a little bit more complicated.
