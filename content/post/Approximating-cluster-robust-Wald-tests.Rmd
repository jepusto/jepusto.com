...
Several of the small-sample approximations that we considered are based on representing the $Q$ statistic as
$$
Q = \bm{z}' \bm{D}^{-1} \bm{z},
$$
...
$$
The approximations involve different approximations based on the sampling distribution of $\bm{D}$. 
